...
//  Conversores
//
//  Created by Pedro Luiz on 22/12/19.
//  Copyright © 2019 Pedro Luiz. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func showNext(_ sender: UIButton) {
        switch lbUnit.text! {
            ...
            default:
                ...
                btUnit2.setTitle("Farenheith", for: .normal)
        }
    ...
    func calcTemperature() {
        ...
        if btUnit1.alpha.isEqual(to: 1.0){
    ...
    func calcCurrency() {
        ...
        if btUnit1.alpha.isEqual(to: 1.0){
            ...
            lbResult.text = String(currency / 4.12)
        } else{
